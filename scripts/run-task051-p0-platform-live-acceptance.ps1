    ...
    if ($semanticField -cne 'NONE') {
        if ($DetailedFailure) {
            switch -CaseSensitive ($semanticField) {
                ...
                'STATUS' { throw 'TASK051_PUBLIC_STATUS_STATUS_REJECTED' }
...
function Resolve-Task051PublicProjectionFailure {
    ...
    switch -CaseSensitive ($Projection + '|' + $Kind + '|' + $Message) {
        ...
        'STRUCTURED|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_REJECTED' }
        ...
        'STRUCTURED|STATUS|TASK051_PUBLIC_STATUS_STATUS_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_REJECTED' }
        ...
        'CONTENT|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_REJECTED' }
        ...
        'CONTENT|STATUS|TASK051_PUBLIC_STATUS_STATUS_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_REJECTED' }
...
function Resolve-Task051CodexToolFailure {
    ...
    switch -CaseSensitive ($Message) {
        ...
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_REJECTED' }
        ...
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_REJECTED' }
        ...
        'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_REJECTED' }
        ...
        'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_REJECTED' }
...
function Invoke-Task051SelfTest {
    ...
    foreach ($structuredFailureFixture in @(
        ...
        [pscustomobject]@{
            ...
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_REJECTED'
        },
        [pscustomobject]@{
        ...
        [pscustomobject]@{
            ...
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_REJECTED'
        },
        [pscustomobject]@{
            Mutation = 'META_SHAPE'
        ...
        [pscustomobject]@{
            ...
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_REJECTED'
        },
        [pscustomobject]@{
            Mutation = 'STRUCTURED_SUBMIT_STATUS'
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_REJECTED'
        },
        [pscustomobject]@{
            Mutation = 'PARITY'
            ...
            foreach ($fieldFixture in @('SCHEMA', 'STATUS', 'TASK_STATE', 'TASK_REF', 'LEDGER_HEAD', 'RESULT_DIGEST')) {
                ...
                foreach ($variantFixture in $variantFixtures) {
                    ...
                    switch -CaseSensitive ($fieldFixture) {
                        ...
                        'STATUS' { $fieldStatus.status = 'RUNNING' }
