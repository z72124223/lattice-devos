            ...
            switch -CaseSensitive ($semanticField) {
                ...
                'STATUS' {
                    if ($Value.status -is [string]) {
                        switch -CaseSensitive ([string]$Value.status) {
                            'NOT_SUBMITTED' { throw 'TASK051_PUBLIC_STATUS_STATUS_NOT_SUBMITTED_REJECTED' }
                            'RECONCILIATION_REQUIRED' { throw 'TASK051_PUBLIC_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
                            'FAILED' { throw 'TASK051_PUBLIC_STATUS_STATUS_FAILED_REJECTED' }
                            'completed' { throw 'TASK051_PUBLIC_STATUS_STATUS_LOWER_COMPLETED_REJECTED' }
                        }
                    }
                    throw 'TASK051_PUBLIC_STATUS_STATUS_OTHER_REJECTED'
                }
                'TASK_STATE' { throw 'TASK051_PUBLIC_STATUS_TASK_STATE_REJECTED' }
...
function Resolve-Task051PublicProjectionFailure {
    ...
    switch -CaseSensitive ($Projection + '|' + $Kind + '|' + $Message) {
        ...
        'STRUCTURED|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_NOT_SUBMITTED_REJECTED' }
        'STRUCTURED|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'STRUCTURED|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_FAILED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_FAILED_REJECTED' }
        'STRUCTURED|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_LOWER_COMPLETED_REJECTED' }
        'STRUCTURED|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_OTHER_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_OTHER_REJECTED' }
        'STRUCTURED|SUBMIT|TASK051_PUBLIC_STATUS_TASK_STATE_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_TASK_STATE_REJECTED' }
        ...
        'STRUCTURED|STATUS|TASK051_PUBLIC_STATUS_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_NOT_SUBMITTED_REJECTED' }
        'STRUCTURED|STATUS|TASK051_PUBLIC_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'STRUCTURED|STATUS|TASK051_PUBLIC_STATUS_STATUS_FAILED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_FAILED_REJECTED' }
        'STRUCTURED|STATUS|TASK051_PUBLIC_STATUS_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_LOWER_COMPLETED_REJECTED' }
        'STRUCTURED|STATUS|TASK051_PUBLIC_STATUS_STATUS_OTHER_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_OTHER_REJECTED' }
        'STRUCTURED|STATUS|TASK051_PUBLIC_STATUS_TASK_STATE_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_TASK_STATE_REJECTED' }
        ...
        'CONTENT|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_NOT_SUBMITTED_REJECTED' }
        'CONTENT|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'CONTENT|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_FAILED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_FAILED_REJECTED' }
        'CONTENT|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_LOWER_COMPLETED_REJECTED' }
        'CONTENT|SUBMIT|TASK051_PUBLIC_STATUS_STATUS_OTHER_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_OTHER_REJECTED' }
        'CONTENT|SUBMIT|TASK051_PUBLIC_STATUS_TASK_STATE_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_TASK_STATE_REJECTED' }
        ...
        'CONTENT|STATUS|TASK051_PUBLIC_STATUS_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_NOT_SUBMITTED_REJECTED' }
        'CONTENT|STATUS|TASK051_PUBLIC_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'CONTENT|STATUS|TASK051_PUBLIC_STATUS_STATUS_FAILED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_FAILED_REJECTED' }
        'CONTENT|STATUS|TASK051_PUBLIC_STATUS_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_LOWER_COMPLETED_REJECTED' }
        'CONTENT|STATUS|TASK051_PUBLIC_STATUS_STATUS_OTHER_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_OTHER_REJECTED' }
        'CONTENT|STATUS|TASK051_PUBLIC_STATUS_TASK_STATE_REJECTED' { return 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_TASK_STATE_REJECTED' }
...
function Resolve-Task051CodexToolFailure {
    ...
    switch -CaseSensitive ($Message) {
        ...
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_NOT_SUBMITTED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_FAILED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_FAILED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_LOWER_COMPLETED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_OTHER_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_OTHER_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_TASK_STATE_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_TASK_STATE_REJECTED' }
        ...
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_NOT_SUBMITTED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_FAILED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_FAILED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_LOWER_COMPLETED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_OTHER_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_OTHER_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_TASK_STATE_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_TASK_STATE_REJECTED' }
        ...
        'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_NOT_SUBMITTED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_FAILED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_FAILED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_LOWER_COMPLETED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_OTHER_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_OTHER_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_TASK_STATE_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_TASK_STATE_REJECTED' }
        ...
        'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_NOT_SUBMITTED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_NOT_SUBMITTED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_RECONCILIATION_REQUIRED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_FAILED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_FAILED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_LOWER_COMPLETED_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_LOWER_COMPLETED_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_OTHER_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_OTHER_REJECTED' }
        'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_TASK_STATE_REJECTED' { return 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_TASK_STATE_REJECTED' }
...
function Invoke-Task051SelfTest {
    ...
    foreach ($structuredFailureFixture in @(
        ...
        [pscustomobject]@{
            ...
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_OTHER_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_STATUS_STATUS_OTHER_REJECTED'
        },
        [pscustomobject]@{
        ...
        [pscustomobject]@{
            ...
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_OTHER_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_CONTENT_SUBMIT_STATUS_OTHER_REJECTED'
        },
        [pscustomobject]@{
            Mutation = 'META_SHAPE'
        ...
        [pscustomobject]@{
            ...
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_OTHER_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_STATUS_STATUS_OTHER_REJECTED'
        },
        [pscustomobject]@{
            Mutation = 'STRUCTURED_SUBMIT_STATUS'
            ExpectedRaw = 'TASK051_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_OTHER_REJECTED'
            ExpectedMapped = 'TASK038_CURRENT_CODEX_TOOL_RESULT_STRUCTURED_SUBMIT_STATUS_OTHER_REJECTED'
        },
        [pscustomobject]@{
            Mutation = 'PARITY'
    ...
    foreach ($projectionFixture in @('STRUCTURED', 'CONTENT')) {
        foreach ($kindFixture in @('SUBMIT', 'STATUS')) {
            foreach ($fieldFixture in @('SCHEMA', 'STATUS', 'TASK_STATE', 'TASK_REF', 'LEDGER_HEAD', 'RESULT_DIGEST')) {
                $variantFixtures = switch -CaseSensitive ($fieldFixture) {
                    'STATUS' { @('NOT_SUBMITTED', 'RECONCILIATION_REQUIRED', 'FAILED', 'LOWER_COMPLETED', 'OTHER'); break }
                ...
                foreach ($variantFixture in $variantFixtures) {
                    ...
                    switch -CaseSensitive ($fieldFixture) {
                        ...
                        'STATUS' {
                            $fieldStatus.status = switch -CaseSensitive ($variantFixture) {
                                'NOT_SUBMITTED' { 'NOT_SUBMITTED'; break }
                                'RECONCILIATION_REQUIRED' { 'RECONCILIATION_REQUIRED'; break }
                                'FAILED' { 'FAILED'; break }
                                'LOWER_COMPLETED' { 'completed'; break }
                                'OTHER' { 'RUNNING'; break }
                            }
                        }
                        'TASK_STATE' { $fieldStatus.task_state = 'RUNNING' }
                    ...
                    $expectedFieldLeaf = if ($fieldFixture -ceq 'STATUS') { 'STATUS_' + $variantFixture } else { $fieldFixture }
                    $expectedFieldFailure = 'TASK051_CODEX_TOOL_RESULT_' + $projectionFixture + '_' + $kindFixture + '_' + $expectedFieldLeaf + '_REJECTED'
