-- LATTICE Codebase Memory extension profile v3.
-- Append-only successor applied only after exact v2 under the administrative runner.
-- The runner owns the transaction, global-before-extension advisory locks, and identity write.

ALTER TABLE memory.codebase_memory_extension_ledger DROP CONSTRAINT codebase_memory_extension_ledger_single_entry, DROP CONSTRAINT codebase_memory_extension_ledger_identity, DROP CONSTRAINT codebase_memory_extension_ledger_singleton_key;
ALTER TABLE memory.codebase_memory_extension_identity DROP CONSTRAINT codebase_memory_extension_identity_version, DROP CONSTRAINT codebase_memory_extension_identity_path, DROP CONSTRAINT codebase_memory_extension_identity_global_version;
ALTER TABLE memory.codebase_memory_extension_identity ADD CONSTRAINT codebase_memory_extension_identity_profile CHECK (((extension_schema_version = 2 AND extension_path = 'db/extensions/codebase-memory/v2.sql' AND global_schema_version = 3) OR (extension_schema_version = 3 AND extension_path = 'db/extensions/codebase-memory/v3.sql' AND global_schema_version = 5)));
ALTER TABLE memory.codebase_memory_extension_ledger ADD CONSTRAINT codebase_memory_extension_ledger_singleton CHECK (singleton), ADD CONSTRAINT codebase_memory_extension_ledger_profile CHECK (((ledger_ordinal = 1 AND extension_schema_version = 2 AND global_schema_version = 3 AND event_kind = 'INSTALLED') OR (ledger_ordinal = 2 AND extension_schema_version = 3 AND global_schema_version = 5 AND event_kind = 'UPGRADED')));

ALTER TABLE memory.codebase_memory_analyses ADD COLUMN persistence_database_identity_sha256 char(64), ADD COLUMN persistence_global_schema_version smallint, ADD COLUMN persistence_global_manifest_sha256 char(64), ADD COLUMN persistence_extension_id varchar(64), ADD COLUMN persistence_extension_schema_version smallint, ADD COLUMN persistence_extension_sql_sha256 char(64), ADD COLUMN persistence_extension_manifest_sha256 char(64);
ALTER TABLE memory.codebase_memory_retrieval_audits ADD COLUMN persistence_database_identity_sha256 char(64), ADD COLUMN persistence_global_schema_version smallint, ADD COLUMN persistence_global_manifest_sha256 char(64), ADD COLUMN persistence_extension_id varchar(64), ADD COLUMN persistence_extension_schema_version smallint, ADD COLUMN persistence_extension_sql_sha256 char(64), ADD COLUMN persistence_extension_manifest_sha256 char(64);
ALTER TABLE memory.codebase_memory_receipts ADD COLUMN persistence_database_identity_sha256 char(64), ADD COLUMN persistence_global_schema_version smallint, ADD COLUMN persistence_global_manifest_sha256 char(64), ADD COLUMN persistence_extension_id varchar(64), ADD COLUMN persistence_extension_schema_version smallint, ADD COLUMN persistence_extension_sql_sha256 char(64), ADD COLUMN persistence_extension_manifest_sha256 char(64);
ALTER TABLE memory.codebase_memory_reflections ADD COLUMN persistence_database_identity_sha256 char(64), ADD COLUMN persistence_global_schema_version smallint, ADD COLUMN persistence_global_manifest_sha256 char(64), ADD COLUMN persistence_extension_id varchar(64), ADD COLUMN persistence_extension_schema_version smallint, ADD COLUMN persistence_extension_sql_sha256 char(64), ADD COLUMN persistence_extension_manifest_sha256 char(64);

UPDATE ONLY memory.codebase_memory_analyses AS a SET persistence_database_identity_sha256=i.database_identity_sha256,persistence_global_schema_version=i.global_schema_version,persistence_global_manifest_sha256=i.global_manifest_sha256,persistence_extension_id=i.extension_id,persistence_extension_schema_version=i.extension_schema_version,persistence_extension_sql_sha256=i.extension_sql_sha256,persistence_extension_manifest_sha256=i.extension_manifest_sha256 FROM ONLY memory.codebase_memory_extension_identity AS i WHERE i.singleton;
UPDATE ONLY memory.codebase_memory_retrieval_audits AS a SET persistence_database_identity_sha256=i.database_identity_sha256,persistence_global_schema_version=i.global_schema_version,persistence_global_manifest_sha256=i.global_manifest_sha256,persistence_extension_id=i.extension_id,persistence_extension_schema_version=i.extension_schema_version,persistence_extension_sql_sha256=i.extension_sql_sha256,persistence_extension_manifest_sha256=i.extension_manifest_sha256 FROM ONLY memory.codebase_memory_extension_identity AS i WHERE i.singleton;
UPDATE ONLY memory.codebase_memory_receipts AS a SET persistence_database_identity_sha256=i.database_identity_sha256,persistence_global_schema_version=i.global_schema_version,persistence_global_manifest_sha256=i.global_manifest_sha256,persistence_extension_id=i.extension_id,persistence_extension_schema_version=i.extension_schema_version,persistence_extension_sql_sha256=i.extension_sql_sha256,persistence_extension_manifest_sha256=i.extension_manifest_sha256 FROM ONLY memory.codebase_memory_extension_identity AS i WHERE i.singleton;
UPDATE ONLY memory.codebase_memory_reflections AS a SET persistence_database_identity_sha256=i.database_identity_sha256,persistence_global_schema_version=i.global_schema_version,persistence_global_manifest_sha256=i.global_manifest_sha256,persistence_extension_id=i.extension_id,persistence_extension_schema_version=i.extension_schema_version,persistence_extension_sql_sha256=i.extension_sql_sha256,persistence_extension_manifest_sha256=i.extension_manifest_sha256 FROM ONLY memory.codebase_memory_extension_identity AS i WHERE i.singleton;

ALTER TABLE memory.codebase_memory_analyses ALTER COLUMN persistence_database_identity_sha256 SET NOT NULL, ALTER COLUMN persistence_global_schema_version SET NOT NULL, ALTER COLUMN persistence_global_manifest_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_id SET NOT NULL, ALTER COLUMN persistence_extension_schema_version SET NOT NULL, ALTER COLUMN persistence_extension_sql_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_manifest_sha256 SET NOT NULL;
ALTER TABLE memory.codebase_memory_retrieval_audits ALTER COLUMN persistence_database_identity_sha256 SET NOT NULL, ALTER COLUMN persistence_global_schema_version SET NOT NULL, ALTER COLUMN persistence_global_manifest_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_id SET NOT NULL, ALTER COLUMN persistence_extension_schema_version SET NOT NULL, ALTER COLUMN persistence_extension_sql_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_manifest_sha256 SET NOT NULL;
ALTER TABLE memory.codebase_memory_receipts ALTER COLUMN persistence_database_identity_sha256 SET NOT NULL, ALTER COLUMN persistence_global_schema_version SET NOT NULL, ALTER COLUMN persistence_global_manifest_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_id SET NOT NULL, ALTER COLUMN persistence_extension_schema_version SET NOT NULL, ALTER COLUMN persistence_extension_sql_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_manifest_sha256 SET NOT NULL;
ALTER TABLE memory.codebase_memory_reflections ALTER COLUMN persistence_database_identity_sha256 SET NOT NULL, ALTER COLUMN persistence_global_schema_version SET NOT NULL, ALTER COLUMN persistence_global_manifest_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_id SET NOT NULL, ALTER COLUMN persistence_extension_schema_version SET NOT NULL, ALTER COLUMN persistence_extension_sql_sha256 SET NOT NULL, ALTER COLUMN persistence_extension_manifest_sha256 SET NOT NULL;

ALTER TABLE memory.codebase_memory_analyses
    ADD CONSTRAINT codebase_memory_analyses_persistence_profile CHECK (
        persistence_extension_id = 'lattice-codebase-memory'
        AND persistence_global_schema_version IN (3, 5)
        AND persistence_extension_schema_version IN (1, 2, 3)
        AND pg_catalog.btrim(persistence_database_identity_sha256) ~ '^[0-9a-f]{64}$'
        AND pg_catalog.btrim(persistence_global_manifest_sha256) ~ '^[0-9a-f]{64}$'
        AND pg_catalog.btrim(persistence_extension_sql_sha256) ~ '^[0-9a-f]{64}$'
        AND pg_catalog.btrim(persistence_extension_manifest_sha256) ~ '^[0-9a-f]{64}$'
        AND ((persistence_global_schema_version = 3 AND persistence_extension_schema_version IN (1, 2)) OR (persistence_global_schema_version = 5 AND persistence_extension_schema_version = 3))
    );
ALTER TABLE memory.codebase_memory_retrieval_audits
    ADD CONSTRAINT codebase_memory_retrieval_persistence_profile CHECK (
        persistence_extension_id = 'lattice-codebase-memory'
        AND persistence_global_schema_version IN (3, 5)
        AND persistence_extension_schema_version IN (1, 2, 3)
        AND pg_catalog.btrim(persistence_database_identity_sha256) ~ '^[0-9a-f]{64}$'
...
ALTER TABLE memory.codebase_memory_receipts
    ADD CONSTRAINT codebase_memory_receipts_persistence_profile CHECK (
        persistence_extension_id = 'lattice-codebase-memory'
        AND persistence_global_schema_version IN (3, 5)
        AND persistence_extension_schema_version IN (1, 2, 3)
        AND pg_catalog.btrim(persistence_database_identity_sha256) ~ '^[0-9a-f]{64}$'
...
ALTER TABLE memory.codebase_memory_reflections
    ADD CONSTRAINT codebase_memory_reflections_persistence_profile CHECK (
        persistence_extension_id = 'lattice-codebase-memory'
        AND persistence_global_schema_version IN (3, 5)
        AND persistence_extension_schema_version IN (1, 2, 3)
        AND pg_catalog.btrim(persistence_database_identity_sha256) ~ '^[0-9a-f]{64}$'
...
CREATE FUNCTION memory.codebase_memory_persist_analysis_v3(
...
AS $lattice_codebase_memory_persist_analysis_v3$
DECLARE
...
BEGIN
    ...
    SELECT d.database_uuid, pg_catalog.count(*)
     ...
     WHERE i.singleton
       AND l.ledger_ordinal = 2
       AND i.extension_id = 'lattice-codebase-memory'
       AND i.extension_schema_version = 3
       AND i.extension_path = 'db/extensions/codebase-memory/v3.sql'
    ...
    IF FOUND THEN
        IF v_analysis.contract_version IS DISTINCT FROM p_contract_version
           ...
           OR pg_catalog.decode(pg_catalog.btrim(v_analysis.persistence_database_identity_sha256), 'hex') IS DISTINCT FROM p_database_identity_digest
           OR v_analysis.persistence_global_schema_version IS DISTINCT FROM 5
           OR pg_catalog.decode(pg_catalog.btrim(v_analysis.persistence_global_manifest_sha256), 'hex') IS DISTINCT FROM p_global_manifest_digest
           OR v_analysis.persistence_extension_id IS DISTINCT FROM 'lattice-codebase-memory'
           OR v_analysis.persistence_extension_schema_version IS DISTINCT FROM 3
           OR pg_catalog.decode(pg_catalog.btrim(v_analysis.persistence_extension_sql_sha256), 'hex') IS DISTINCT FROM p_extension_sql_digest
           OR pg_catalog.decode(pg_catalog.btrim(v_analysis.persistence_extension_manifest_sha256), 'hex') IS DISTINCT FROM p_extension_manifest_digest
        THEN
    ...
    INSERT INTO memory.codebase_memory_analyses (
        ...
        persistence_digest, persistence_database_identity_sha256,
        persistence_global_schema_version, persistence_global_manifest_sha256,
        persistence_extension_id, persistence_extension_schema_version,
        persistence_extension_sql_sha256, persistence_extension_manifest_sha256
    ) VALUES (
        ...
        p_persistence_digest, pg_catalog.encode(p_database_identity_digest, 'hex'),
        5, pg_catalog.encode(p_global_manifest_digest, 'hex'),
        'lattice-codebase-memory', 3,
        pg_catalog.encode(p_extension_sql_digest, 'hex'),
        pg_catalog.encode(p_extension_manifest_digest, 'hex')
    );
...
CREATE FUNCTION memory.codebase_memory_persist_retrieval_v3(
    p_database_identity_digest bytea,
    p_global_manifest_digest bytea,
    p_extension_sql_digest bytea,
    p_extension_manifest_digest bytea,
...
SET lock_timeout = '5s'
SET statement_timeout = '30s'
AS $lattice_codebase_memory_persist_retrieval_v3$
DECLARE
    v_analysis memory.codebase_memory_analyses%ROWTYPE;
...
BEGIN
    ...
    SELECT pg_catalog.count(*) INTO v_identity_count
      ...
      CROSS JOIN ONLY control.database_identity AS d
      CROSS JOIN ONLY control.schema_compatibility AS c
     WHERE i.singleton AND l.ledger_ordinal = 2
       AND i.database_uuid = d.database_uuid
       AND i.global_schema_version = c.current_schema_version
       AND c.current_schema_version = 5
       AND pg_catalog.decode(pg_catalog.btrim(i.database_identity_sha256), 'hex') = p_database_identity_digest
    ...
    IF FOUND THEN
        ...
        IF NOT FOUND
           ...
           OR v_audit.persistence_database_identity_sha256 IS DISTINCT FROM v_analysis.persistence_database_identity_sha256
           OR v_audit.persistence_global_schema_version IS DISTINCT FROM v_analysis.persistence_global_schema_version
           OR v_audit.persistence_global_manifest_sha256 IS DISTINCT FROM v_analysis.persistence_global_manifest_sha256
           OR v_audit.persistence_extension_id IS DISTINCT FROM v_analysis.persistence_extension_id
           OR v_audit.persistence_extension_schema_version IS DISTINCT FROM v_analysis.persistence_extension_schema_version
           OR v_audit.persistence_extension_sql_sha256 IS DISTINCT FROM v_analysis.persistence_extension_sql_sha256
           OR v_audit.persistence_extension_manifest_sha256 IS DISTINCT FROM v_analysis.persistence_extension_manifest_sha256
           OR v_receipt.persistence_database_identity_sha256 IS DISTINCT FROM v_analysis.persistence_database_identity_sha256
           OR v_receipt.persistence_global_schema_version IS DISTINCT FROM v_analysis.persistence_global_schema_version
           OR v_receipt.persistence_global_manifest_sha256 IS DISTINCT FROM v_analysis.persistence_global_manifest_sha256
           OR v_receipt.persistence_extension_id IS DISTINCT FROM v_analysis.persistence_extension_id
           OR v_receipt.persistence_extension_schema_version IS DISTINCT FROM v_analysis.persistence_extension_schema_version
           OR v_receipt.persistence_extension_sql_sha256 IS DISTINCT FROM v_analysis.persistence_extension_sql_sha256
           OR v_receipt.persistence_extension_manifest_sha256 IS DISTINCT FROM v_analysis.persistence_extension_manifest_sha256
        THEN
    ...
    INSERT INTO memory.codebase_memory_retrieval_audits (
        ...
        persistence_database_identity_sha256, persistence_global_schema_version,
        persistence_global_manifest_sha256, persistence_extension_id,
        persistence_extension_schema_version, persistence_extension_sql_sha256,
        ...
        p_result_set_digest, v_analysis.persistence_database_identity_sha256,
        v_analysis.persistence_global_schema_version,
        v_analysis.persistence_global_manifest_sha256,
        v_analysis.persistence_extension_id,
        v_analysis.persistence_extension_schema_version,
        v_analysis.persistence_extension_sql_sha256,
        v_analysis.persistence_extension_manifest_sha256
    );
    INSERT INTO memory.codebase_memory_receipts (
        receipt_digest, analysis_digest, retrieval_digest, persistence_digest,
        query_digest, persistence_database_identity_sha256,
        persistence_global_schema_version, persistence_global_manifest_sha256,
        persistence_extension_id, persistence_extension_schema_version,
        persistence_extension_sql_sha256, persistence_extension_manifest_sha256
    ) VALUES (
        ...
        v_analysis.persistence_database_identity_sha256,
        v_analysis.persistence_global_schema_version,
        v_analysis.persistence_global_manifest_sha256,
        v_analysis.persistence_extension_id,
        v_analysis.persistence_extension_schema_version,
...
CREATE FUNCTION memory.codebase_memory_load_receipt_v3(
    p_database_identity_digest bytea,
    p_global_manifest_digest bytea,
    p_extension_sql_digest bytea,
    p_extension_manifest_digest bytea,
...
RETURNS TABLE (
    ...
    persistence_database_identity_sha256 text,
    persistence_global_schema_version smallint,
    persistence_global_manifest_sha256 text,
    persistence_extension_id text,
    persistence_extension_schema_version smallint,
    persistence_extension_sql_sha256 text,
    persistence_extension_manifest_sha256 text
)
LANGUAGE plpgsql
STABLE
PARALLEL RESTRICTED
...
SET lock_timeout = '5s'
SET statement_timeout = '30s'
AS $lattice_codebase_memory_load_receipt_v3$
DECLARE
    v_identity_count bigint;
BEGIN
    IF session_user <> 'lattice_runtime_login'
    ...
    SELECT a.analysis_digest,
           ...
           r.retrieval_digest,
           x.receipt_digest,
           pg_catalog.btrim(a.persistence_database_identity_sha256)::text,
           a.persistence_global_schema_version,
           pg_catalog.btrim(a.persistence_global_manifest_sha256)::text,
           a.persistence_extension_id::text,
           a.persistence_extension_schema_version,
           pg_catalog.btrim(a.persistence_extension_sql_sha256)::text,
           pg_catalog.btrim(a.persistence_extension_manifest_sha256)::text
     ...
     WHERE a.contract_version = p_contract_version
       ...
       AND r.persistence_database_identity_sha256 = a.persistence_database_identity_sha256
       AND r.persistence_global_schema_version = a.persistence_global_schema_version
       AND r.persistence_global_manifest_sha256 = a.persistence_global_manifest_sha256
       AND r.persistence_extension_id = a.persistence_extension_id
       AND r.persistence_extension_schema_version = a.persistence_extension_schema_version
       AND r.persistence_extension_sql_sha256 = a.persistence_extension_sql_sha256
       AND r.persistence_extension_manifest_sha256 = a.persistence_extension_manifest_sha256
       AND x.persistence_database_identity_sha256 = a.persistence_database_identity_sha256
       AND x.persistence_global_schema_version = a.persistence_global_schema_version
       AND x.persistence_global_manifest_sha256 = a.persistence_global_manifest_sha256
       AND x.persistence_extension_id = a.persistence_extension_id
       AND x.persistence_extension_schema_version = a.persistence_extension_schema_version
       AND x.persistence_extension_sql_sha256 = a.persistence_extension_sql_sha256
       AND x.persistence_extension_manifest_sha256 = a.persistence_extension_manifest_sha256
       AND (
           (a.persistence_global_schema_version = 3
            AND a.persistence_extension_schema_version IN (1, 2)
            AND a.persistence_global_manifest_sha256 = '09c431df18ad71a4f44239a5d2ddf6b1774b8ffec06c7f9223f0e41757f3d407')
           OR
           (a.persistence_global_schema_version = 5
            AND a.persistence_extension_schema_version = 3)
       );
    IF NOT FOUND THEN
...
CREATE FUNCTION memory.codebase_memory_persist_reflection_v3(
    p_database_identity_digest bytea,
    p_global_manifest_digest bytea,
    p_extension_sql_digest bytea,
    p_extension_manifest_digest bytea,
...
SET lock_timeout = '5s'
SET statement_timeout = '30s'
AS $lattice_codebase_memory_persist_reflection_v3$
DECLARE
    v_identity_count bigint;
...
BEGIN
    ...
    SELECT pg_catalog.count(*) INTO v_graph_count
     ...
     JOIN ONLY memory.codebase_memory_retrieval_audits AS r
       ON r.retrieval_digest = x.retrieval_digest
      AND r.analysis_digest = x.analysis_digest
     ...
     WHERE x.receipt_digest = p_graph_receipt_digest
       ...
       AND a.configuration_digest = p_configuration_digest
       AND a.retrieval_limit = p_retrieval_limit
       AND a.persistence_global_schema_version = 5
       AND a.persistence_extension_schema_version = 3
       AND pg_catalog.decode(pg_catalog.btrim(a.persistence_database_identity_sha256), 'hex') = p_database_identity_digest
       AND pg_catalog.decode(pg_catalog.btrim(a.persistence_global_manifest_sha256), 'hex') = p_global_manifest_digest
       AND pg_catalog.decode(pg_catalog.btrim(a.persistence_extension_sql_sha256), 'hex') = p_extension_sql_digest
       AND pg_catalog.decode(pg_catalog.btrim(a.persistence_extension_manifest_sha256), 'hex') = p_extension_manifest_digest
       AND x.persistence_database_identity_sha256 = a.persistence_database_identity_sha256
       AND x.persistence_global_schema_version = a.persistence_global_schema_version
       AND x.persistence_global_manifest_sha256 = a.persistence_global_manifest_sha256
       AND x.persistence_extension_id = a.persistence_extension_id
    ...
    SELECT pg_catalog.count(*) INTO v_exact_count
      ...
      JOIN ONLY memory.codebase_memory_receipts AS x
        ON x.receipt_digest = h.graph_receipt_digest
      JOIN ONLY memory.codebase_memory_retrieval_audits AS r
        ON r.retrieval_digest = x.retrieval_digest
       AND r.analysis_digest = x.analysis_digest
      JOIN ONLY memory.codebase_memory_analyses AS a
     ...
     WHERE h.reflection_receipt_digest = p_reflection_receipt_digest
       ...
       AND h.persistence_global_schema_version = 5
       AND h.persistence_extension_schema_version = 3
       AND pg_catalog.decode(pg_catalog.btrim(h.persistence_database_identity_sha256), 'hex') = p_database_identity_digest
       AND pg_catalog.decode(pg_catalog.btrim(h.persistence_global_manifest_sha256), 'hex') = p_global_manifest_digest
       AND pg_catalog.decode(pg_catalog.btrim(h.persistence_extension_sql_sha256), 'hex') = p_extension_sql_digest
       AND pg_catalog.decode(pg_catalog.btrim(h.persistence_extension_manifest_sha256), 'hex') = p_extension_manifest_digest
       AND r.persistence_database_identity_sha256 = a.persistence_database_identity_sha256
       AND r.persistence_global_schema_version = a.persistence_global_schema_version
       AND r.persistence_global_manifest_sha256 = a.persistence_global_manifest_sha256
       AND r.persistence_extension_id = a.persistence_extension_id
       ...
       AND x.persistence_extension_sql_sha256 = a.persistence_extension_sql_sha256
       AND x.persistence_extension_manifest_sha256 = a.persistence_extension_manifest_sha256
       AND h.persistence_database_identity_sha256 = a.persistence_database_identity_sha256
       AND h.persistence_global_schema_version = a.persistence_global_schema_version
       AND h.persistence_global_manifest_sha256 = a.persistence_global_manifest_sha256
       AND h.persistence_extension_id = a.persistence_extension_id
       AND h.persistence_extension_schema_version = a.persistence_extension_schema_version
       AND h.persistence_extension_sql_sha256 = a.persistence_extension_sql_sha256
       AND h.persistence_extension_manifest_sha256 = a.persistence_extension_manifest_sha256;
    ...
    INSERT INTO memory.codebase_memory_reflections (
        ...
        next_actions, persistence_database_identity_sha256,
        persistence_global_schema_version, persistence_global_manifest_sha256,
        persistence_extension_id, persistence_extension_schema_version,
        persistence_extension_sql_sha256, persistence_extension_manifest_sha256
    ) VALUES (
        ...
        p_next_actions, pg_catalog.encode(p_database_identity_digest, 'hex'),
        5, pg_catalog.encode(p_global_manifest_digest, 'hex'),
        'lattice-codebase-memory', 3,
        pg_catalog.encode(p_extension_sql_digest, 'hex'),
        pg_catalog.encode(p_extension_manifest_digest, 'hex')
...
CREATE FUNCTION memory.codebase_memory_load_reflection_v3(
    p_database_identity_digest bytea,
    p_global_manifest_digest bytea,
    p_extension_sql_digest bytea,
    p_extension_manifest_digest bytea,
...
SET lock_timeout = '5s'
SET statement_timeout = '30s'
AS $lattice_codebase_memory_load_reflection_v3$
DECLARE
    v_identity_count bigint;
BEGIN
    IF session_user <> 'lattice_runtime_login'
    ...
    SELECT h.graph_receipt_digest,
           ...
           h.next_actions,
           pg_catalog.btrim(h.persistence_database_identity_sha256)::text,
           h.persistence_global_schema_version,
           pg_catalog.btrim(h.persistence_global_manifest_sha256)::text,
           h.persistence_extension_id::text,
           h.persistence_extension_schema_version,
           pg_catalog.btrim(h.persistence_extension_sql_sha256)::text,
           pg_catalog.btrim(h.persistence_extension_manifest_sha256)::text
      FROM ONLY memory.codebase_memory_reflections AS h
      JOIN ONLY memory.codebase_memory_receipts AS x
        ON x.receipt_digest = h.graph_receipt_digest
      JOIN ONLY memory.codebase_memory_retrieval_audits AS r
     ...
     WHERE h.contract_version = p_contract_version
       ...
       AND h.persistence_extension_manifest_sha256 = a.persistence_extension_manifest_sha256
       AND (
           (h.persistence_global_schema_version = 3
            AND h.persistence_extension_schema_version = 2
            AND h.persistence_global_manifest_sha256 = '09c431df18ad71a4f44239a5d2ddf6b1774b8ffec06c7f9223f0e41757f3d407')
           OR
           (h.persistence_global_schema_version = 5
            AND h.persistence_extension_schema_version = 3)
       );
    IF NOT FOUND THEN
...
CREATE FUNCTION memory.openclaw_gateway_reconcile_and_claim_v3(
    p_database_identity_digest bytea,
    p_global_manifest_digest bytea,
    p_extension_sql_digest bytea,
    p_extension_manifest_digest bytea,
...
SET lock_timeout = '5s'
SET statement_timeout = '30s'
AS $lattice_openclaw_gateway_reconcile_and_claim_v3$
DECLARE
    v_identity_count bigint;
...
CREATE FUNCTION memory.openclaw_gateway_finalize_terminal_v3(
    p_database_identity_digest bytea,
    p_global_manifest_digest bytea,
    p_extension_sql_digest bytea,
    p_extension_manifest_digest bytea,
...
SET lock_timeout = '5s'
SET statement_timeout = '30s'
AS $lattice_openclaw_gateway_finalize_terminal_v3$
DECLARE
    v_identity_count bigint;
    v_command memory.openclaw_gateway_commands%ROWTYPE;
BEGIN
...
GRANT EXECUTE ON FUNCTION memory.codebase_memory_persist_analysis_v3(
...
GRANT EXECUTE ON FUNCTION memory.codebase_memory_persist_retrieval_v3(
    bytea, bytea, bytea, bytea, bytea, bytea, bytea, smallint, text,
    bytea[], bytea[], bigint[], bytea, bytea, bytea
) TO lattice_runtime;
GRANT EXECUTE ON FUNCTION memory.codebase_memory_load_receipt_v3(
    bytea, bytea, bytea, bytea, smallint, text, text, text, text, bytea,
    text, text, bytea, bytea, smallint
) TO lattice_runtime;
GRANT EXECUTE ON FUNCTION memory.codebase_memory_persist_reflection_v3(
    bytea, bytea, bytea, bytea, smallint, text, text, text, text, bytea,
    text, text, bytea, bytea, smallint, bytea, text, text, bytea, bytea,
    bytea, bytea, text, text[], bytea[], text[]
) TO lattice_runtime;
GRANT EXECUTE ON FUNCTION memory.codebase_memory_load_reflection_v3(
    bytea, bytea, bytea, bytea, smallint, text, text, text, text, bytea,
    text, text, bytea, bytea, smallint
) TO lattice_runtime;
GRANT EXECUTE ON FUNCTION memory.openclaw_gateway_reconcile_and_claim_v3(
    bytea, bytea, bytea, bytea, text, text, bigint, text, bytea
) TO lattice_runtime;
GRANT EXECUTE ON FUNCTION memory.openclaw_gateway_finalize_terminal_v3(
...
COMMENT ON FUNCTION memory.codebase_memory_persist_analysis_v3(
    bytea, bytea, bytea, bytea, smallint, text, text, text, text, bytea,
    text, text, bytea, bytea, smallint, text, bytea, bytea, bytea, bytea,
    bytea, bytea, bytea, bytea, bytea, integer[], bytea[], text[], text[],
    text[], text[], text[], text[], bytea[], integer[], integer[], text[], bytea[]
) IS 'LATTICE_CODEBASE_MEMORY_PERSIST_ANALYSIS_V3';
COMMENT ON FUNCTION memory.codebase_memory_persist_retrieval_v3(
    bytea, bytea, bytea, bytea, bytea, bytea, bytea, smallint, text,
    bytea[], bytea[], bigint[], bytea, bytea, bytea
) IS 'LATTICE_CODEBASE_MEMORY_PERSIST_RETRIEVAL_V3';
COMMENT ON FUNCTION memory.codebase_memory_load_receipt_v3(
    bytea, bytea, bytea, bytea, smallint, text, text, text, text, bytea,
    text, text, bytea, bytea, smallint
) IS 'LATTICE_CODEBASE_MEMORY_LOAD_RECEIPT_V3';
COMMENT ON FUNCTION memory.codebase_memory_persist_reflection_v3(
    bytea, bytea, bytea, bytea, smallint, text, text, text, text, bytea,
    text, text, bytea, bytea, smallint, bytea, text, text, bytea, bytea,
    bytea, bytea, text, text[], bytea[], text[]
) IS 'LATTICE_CODEBASE_MEMORY_PERSIST_REFLECTION_V3';
COMMENT ON FUNCTION memory.codebase_memory_load_reflection_v3(
    bytea, bytea, bytea, bytea, smallint, text, text, text, text, bytea,
    text, text, bytea, bytea, smallint
) IS 'LATTICE_CODEBASE_MEMORY_LOAD_REFLECTION_V3';
COMMENT ON FUNCTION memory.openclaw_gateway_reconcile_and_claim_v3(
    bytea, bytea, bytea, bytea, text, text, bigint, text, bytea
) IS 'LATTICE_OPENCLAW_GATEWAY_RECONCILE_AND_CLAIM_V3';
COMMENT ON FUNCTION memory.openclaw_gateway_finalize_terminal_v3(
    bytea, bytea, bytea, bytea, text, text, bigint, text, bytea, bytea, bytea, bytea
) IS 'LATTICE_OPENCLAW_GATEWAY_FINALIZE_TERMINAL_V3';
