...
BEGIN
    ...
    IF NOT (
        ...
        AND (SELECT pg_catalog.count(*)
              ...
              WHERE c.singleton
                AND c.manifest_sha256 = 'e2f1849bf17f78d60e921cbdcff01aced0516214c2216cb0e7c2f541b68ae439'
              ...
              WHERE w.singleton AND m.singleton
                ...
                AND ((w.global_schema_version = 5 AND w.global_manifest_sha256 =
                  ...
                  OR (w.global_schema_version = 6 AND w.global_manifest_sha256 =
                    'e2f1849bf17f78d60e921cbdcff01aced0516214c2216cb0e7c2f541b68ae439'))) = 1
