...
BEGIN
    ...
    IF NOT (
        ...
        AND (SELECT pg_catalog.count(*)
              ...
              WHERE c.singleton
                AND c.manifest_sha256 = '75189dea7cd2cb95b694bade467c2b5c40373436fb1b3d48e9017b50a9d206ae'
              ...
              WHERE w.singleton AND m.singleton
                ...
                AND ((w.global_schema_version = 5 AND w.global_manifest_sha256 =
                  ...
                  OR (w.global_schema_version = 6 AND w.global_manifest_sha256 =
                    '75189dea7cd2cb95b694bade467c2b5c40373436fb1b3d48e9017b50a9d206ae'))) = 1
