...
| Architecture-review follow-up | Constitutions align exact-v5 transition and exact-v6 retry; SPEC module identity/impact corrected; static contract names all five Writer procedure locks | pending local verification; author repair only, not independent pass |
