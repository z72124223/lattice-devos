...
export const LAUNCH_RECORD_SCHEMA = "lattice-openclaw-launch-record-v1";
...
export function readLatticeLaunchEnvironment(environment = process.env) {
    ...
    const deadlineMs = parseBoundedInteger(environment[LAUNCH_ENVIRONMENT_KEYS.deadlineMs], 30_000);
    if (launchRecordId === undefined ||
...
export function validateLatticeOwnedLaunchRecord(record) {
    if (record.schema !== LAUNCH_RECORD_SCHEMA ||
