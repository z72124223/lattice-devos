...
Assert-True -Condition ($success.Summary.counts.submit_count -eq 1 -and $success.Summary.counts.status_count -eq 1 -and $success.Summary.counts.retry_count -eq 0) -Message 'success action counts'
...
Assert-True -Condition ($submitFailure.Summary.counts.submit_count -eq 1 -and $submitFailure.Summary.counts.status_count -eq 0 -and $submitFailure.Summary.counts.retry_count -eq 0) -Message 'submit failure counts'
...
Assert-True -Condition ($statusMismatch.Summary.counts.submit_count -eq 1 -and $statusMismatch.Summary.counts.status_count -eq 1 -and $statusMismatch.Summary.counts.retry_count -eq 0) -Message 'status mismatch counts'
