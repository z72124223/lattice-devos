...
- Stage 1 durable receipt commit `03cdcdd7e1e401e3e197bbe313cd8f17f70c4f0a` equals the fresh remote read at `2026-08-11T22:57:37.3557589Z`. Stage 2 is this confirmation-only saver advance; its fresh remote equality is reported after push. Authoritative `safe_to_archive=false` remains unchanged; outer saver safety becomes true only after stage 2 equality.
