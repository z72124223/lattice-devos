...
- Config, handoff, holder listener, binary, client, prepared config, protected script, and non-saver paths remained preserved. Stage 1 receipt commit `090408477ec4fb07a8709820b9ab4a61bb9d3d04` matched fresh live remote at `2026-08-11T22:34:35.5531614Z`; stage 2 is confirmation-only. Outer saver state advances to `safe_to_archive=true`.
